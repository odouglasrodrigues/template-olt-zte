...
def CronModify(ip, user, password, port, hostname):
    ...
    time.sleep(.4)
    os.system(
        'sudo echo "27 */2 * * * zabbix python3 -u /usr/lib/zabbix/externalscripts/GetONUSignal-ZTE.py {} {} {} {} {} &">>/etc/cron.d/TemplateOLT'
        .format(ip, user, password, port, hostname))
    time.sleep(.4)
    os.system(
        'sudo echo "*/6 * * * * zabbix python3 -u /usr/lib/zabbix/externalscripts/GetONUOnline-ZTE.py {} {} {} {} {} &">>/etc/cron.d/TemplateOLT'
        .format(ip, user, password, port, hostname))
    time.sleep(.4)
